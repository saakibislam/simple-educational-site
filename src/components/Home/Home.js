        ...
        <div>
            <div className="banner-container">
                <div>
                    ...
                    <button className="btn btn-lg btn-success"><a href="/courses" className="text-white text-decoration-none">Get Started <span className="ms-1"><FontAwesomeIcon icon={faPlay} /></span></a></button>
                </div>
